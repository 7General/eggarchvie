...
(function(global, factory) {
  ...
  function assertProp(
    ...
    const haveExpectedTypes = expectedTypes.some(function(t) { return t; });
  ...
  const KeepAlive = {
    ...
    methods: {
      cacheVNode: function cacheVNode() {
        ...
        const keys = ref.keys;
        const vnodeToCache = ref.vnodeToCache;
        const keyToCache = ref.keyToCache;
        if (vnodeToCache) {
  ...
  function parseHTML(html, options) {
    ...
    function handleStartTag(match) {
      ...
      if (!unary) {
        stack.push({ tag: tagName, lowerCasedTag: tagName.toLowerCase(), attrs, start: match.start, end: match.end });
        lastTag = tagName;
      }
